...
function fmRenderProfileCard(a, mode) {
  ...
  return '<div style="position:relative;width:100%;height:280px;border-radius:16px;overflow:hidden;cursor:pointer;background:' + bgCss + ';" onclick="' + click + '">'
    + overlay
    ...
    + '<div><div style="font-size:13px;font-weight:700;color:#fff;line-height:1.2;">' + followers + '</div><div style="font-size:12px;color:rgba(255,255,255,0.55);text-transform:uppercase;letter-spacing:0.06em;">Followers</div></div>'
    + '<div><div style="font-size:13px;font-weight:700;color:#fff;line-height:1.2;">' + streams + '</div><div style="font-size:12px;color:rgba(255,255,255,0.55);text-transform:uppercase;letter-spacing:0.06em;">Streams</div></div>'
    + '</div>'
    + '</div>'
    + '</div>';
}
